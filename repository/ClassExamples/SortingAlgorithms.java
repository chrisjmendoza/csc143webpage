...
public class SortingAlgorithms {
	...
	private void insert(int i) {
		// a[0] through a[i-1] are sorted
		// insert a[i] at the right location
		int temp = a[i];
		int k;
	...
	private void pickPivotAndSort(int first, int last) {
		if (first < last) {
			...
			// put the pivot at its correct location
			swap(first, toTheLeft);
	...
	public void radixSort() {
		...
		ArrayList<Integer>[] groups = new ArrayList[10];
